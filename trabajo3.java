public class Banco {
    ...
    public void mostrarTotalesCliente() {
        System.out.println("Total del cliente, " + cliente1.retornarNombre() + " = " + cliente.retornarMonto());
        System.out.println("Total del cliente, " + cliente2.retornarNombre() + " = " + cliente.retornarMonto());
        System.out.println("Total del cliente, " + cliente3.retornarNombre() + " = " + cliente.retornarMonto());
    }
